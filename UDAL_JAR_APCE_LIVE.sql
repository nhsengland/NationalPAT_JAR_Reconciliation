...
FROM [Reporting_MESH_APC].[APCE_Core_Union] as apc
...
LEFT JOIN [Reporting_MESH_APC].[APCS_2425_Der_Union] AS Der2425		
	ON apc.APCE_Ident = Der2425.APCS_Ident

--Join to Der table to bring Discharge TFC

LEFT JOIN [Reporting_MESH_APC].[APCS_Core_Union] AS Sp	
